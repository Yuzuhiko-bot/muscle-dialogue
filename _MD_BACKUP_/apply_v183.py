...
def apply_v183_no_accents():
    # V183: Remove the 3-line accent marks as requested by the user.
    # Keep the clean Lucide-style bicep outline.
    ...
    # Bump version to V183
    content = content.replace('?v=182', '?v=183')
    ...
    with open('app.js', 'r', encoding='utf-8') as f:
        app_js = f.read()
    app_js = app_js.replace("const APP_VERSION = 'v182';", "const APP_VERSION = 'v183';")
    ...
    with open('sw.js', 'r', encoding='utf-8') as f:
        sw_js = f.read()
    sw_js = sw_js.replace("muscle-dialogue-v182", "muscle-dialogue-v183")
    sw_js = sw_js.replace("?v=182", "?v=183")
    with open('sw.js', 'w', encoding='utf-8') as f:
        f.write(sw_js)

    print("Success: Applied V183 (Accents removed).")

if __name__ == "__main__":
    apply_v183_no_accents()
